 ...
 *
 *	Can be combined with @ref VarTypes_t
 */
typedef enum
{
	VT_VAR_FLAG_ROLL 				= 16,
	VT_VAR_FLAG_PITCH 				= 32,
	VT_VAR_FLAG_YAW 				= 48,
 ...
 *			RX (2 + ?) bytes
 *
 *	@ref	SBGC32_RealTimeDataCustom function
 */
typedef struct __PACKED__
{
 ...
 *
 *	@ref	SBGC32_DebugVarInfo function\n
 *	@ref	SBGC32_DebugVarValue function
 */
typedef struct
{
 ...
 * 	@{
 */
/* NT! */	TxRxStatus_t SBGC32_RequestDebugVarInfo3 (GeneralSBGC_t *generalSBGC, DebugVars3_t *debugVars3);
/* NT! */	TxRxStatus_t SBGC32_RequestDebugVarValue3 (GeneralSBGC_t *generalSBGC, DebugVars3_t *debugVars3);
/**	@}
 */

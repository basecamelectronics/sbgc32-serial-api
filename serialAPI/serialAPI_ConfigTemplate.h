 ...
 *									 Library General
 */
#define		SBGC_ADJVAR_MODULE		SET_OFF			/*!<  Allow work with adjustable variables											*/
...
#define		SBGC_CONTROL_MODULE		SET_OFF			/*!<  Allow gimbal control															*/
...
#define		SBGC_REALTIME_MODULE	SET_OFF			/*!<  Allow realtime data processing												*/
#define		SBGC_SERVICE_MODULE		SET_OFF			/*!<  Allow work with service functions												*/
...
#define		SBGC_CONFIRM_CMD		SET_OFF			/*!<  Service flag that responsible for CMD_CONFIRM commands handling
...
#define		SBGC_ADJ_VARS_REF_INFO	SET_OFF			/*!<  Debug mode flag for getting access to auxiliary adjustable variable info		*/
...
#define		SBGC_USE_STM32_DRIVER	SET_OFF			/*!<  Using a STM32 controller as a master device									*/
/**	@}
 */
	...
	#define	DRV_USE_CUBEMX			SET_ON			/*!<  If set off: whole SBGC32 driver configured manually
		...
		#define	DRV_HAL_TIMER		SET_OFF			/*!<  Timer driver works with NVIC through HAL										*/

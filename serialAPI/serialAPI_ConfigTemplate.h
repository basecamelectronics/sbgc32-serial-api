...
#define		SBGC_CONTROL_MODULE		sbgcOFF			/*!<  Gimbal control. See @ref Gimbal_Control module								*/
...
#define		SBGC_SERVICE_MODULE		sbgcOFF			/*!<  Service functions. See @ref Service module									*/
...
#define		SBGC_USE_LINUX_OS		sbgcOFF			/*!<  User's application uses Linux OS (POSIX). Enable support of POSIX Thread		*/
	...
	#if ((SBGC_USE_LINUX_OS == sbgcOFF) || SBGC_USES_DOXYGEN)

...
typedef enum
{
	...
	/** only for SBGC32_ManageProfileSet function */
	P_BACKUP_SLOT					= 5,
 ...
 *
 *	Can be combined with @ref ForcePositionCfgFlag_t
 */
typedef enum
{
	FPCS_SNAP_ANGLE_0				= 0,
...
typedef struct __PACKED__
{
    ...
    ui8     RC_Cmd_Low,								/*!<  ...																			*/
			...
			MenuBtnCmd4,							/*!<  ...																			*/
			MenuBtnCmd5,							/*!<  ...																			*/
			MenuBtnCmdLong;							/*!<  See @ref MenuCommand_t enumeration											*/
    ...
    ui8     beeperModes;							/*!<  See @ref BeeperMode_t enumeration												*/
	...
	/**	@cond
	 */
	extern const ParameterReferenceInfo_t mainParams3_ReferenceInfoArray [];
...
typedef struct __PACKED__
{
    ...
    i16     encoderFldOffset [3];					/*!<  Units: 0.02197265625 degree 	 												*/
	...
	/**	@cond
	 */
	extern const ParameterReferenceInfo_t mainParamsExtReferenceInfoArray [];
...
typedef struct __PACKED__
{
    ...
    /* frw. ver. 2.66+ */
    ui8     startupAction [4];						/*!<  See @ref MenuCommand_t enumeration											*/
    ...
    StepSignalN_t	StepSignalN [6];				/*!<  0 : 1 : 2 : 3 : 4 : 5															*/

    RC_CalibN_t	RC_CalibN [5];						/*!<  0 : 1 : 2 : 3 : 4																*/
	...
	/**	@cond
	 */
	extern const ParameterReferenceInfo_t mainParamsExt2_ReferenceInfoArray [];
...
typedef struct __PACKED__
{
	...
	/**	@cond
	 */
	extern const ParameterReferenceInfo_t mainParamsExt3_ReferenceInfoArray [];

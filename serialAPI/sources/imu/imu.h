...
typedef struct __PACKED__
{
	...
	/**	@cond
	 */
	extern const ParameterReferenceInfo_t extIMU_DebugInfoReferenceInfoArray [];
...
typedef struct __PACKED__
{
	...
	/**	@cond
	 */
	extern const ParameterReferenceInfo_t gyroCorrectionReferenceInfoArray [];
...
typedef struct __PACKED__
{
	...
	/**	@cond
	 */
	extern const ParameterReferenceInfo_t AHRS_HelperReferenceInfoArray [];
...
typedef struct __PACKED__
{
	...
	/**	@cond
	 */
	extern const ParameterReferenceInfo_t helperDataReferenceInfoArray [];
...
typedef struct __PACKED__
{
	...
	/**	@cond
	 */
	extern const ParameterReferenceInfo_t helperDataExtReferenceInfoArray [];

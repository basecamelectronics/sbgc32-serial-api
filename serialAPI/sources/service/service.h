 ...
 *
 *	Can be combined with @ref AutoPID2_AxisNotchFilter_t
 */
typedef enum
{
...
/**	@note	AxisAPID2_t.axisFlag
 *
 *	Can be combined with @ref AutoPID2_AxisFlag_t
 */
typedef enum
{
 ...
 */
static inline ui8 PackAPID_AxisFlag (AutoPID2_AxisFlag_t flag, AutoPID2_AxisNotchFilter_t filter)
{
	return (flag & 0b00000011) | ((filter << 2) & 0b00001100);
}


/**	@note	AutoPID2_t.generalFlags
 */
typedef enum
{
...
}	AutoPID2_GeneralFlag_t;


/**	@note	AutoPID2_t.startupCfg
 */
typedef enum
{
	APID2SC_DISABLE					= 0,
...
typedef struct __PACKED__
{
	...
	ui16	boardFeatures;							/*!<  See @ref BoardFeature_t enumeration											*/
	ui8		connectionFlag;							/*!<  See @ref ConnectionFlag_t enumeration											*/
	ui32	frwExtraID;								/*!<  Used for specific builds only													*/
	ui16	boardFeaturesExt;						/*!<  Continues boardFeatures. See @ref BoardFeatureExt_t enumeration				*/
	ui8		reserved [3];
	...
	/**	@cond
	 */
	extern const ParameterReferenceInfo_t boardInfoReferenceInfoArray [];
...
typedef struct __PACKED__
{
	...
	/**	@cond
	 */
	extern const ParameterReferenceInfo_t boardInfo3_ReferenceInfoArray [];
...
typedef struct __PACKED__
{
	...
	/**	@cond
	 */
	extern const ParameterReferenceInfo_t autoPID_ReferenceInfoArray [];
 ...
 *
 * 	@note	AutoPID2_t.AxisAPID2_t
 */
typedef struct __PACKED__
{
	ui8		axisFlag,								/*!<  See @ref AutoPID2_AxisFlag_t and @ref AutoPID2_AxisNotchFilter_t
														  enumerations																	*/
...
typedef struct __PACKED__
{
	ui8		action;									/*!<  See @ref AutoPID2_Action_t enumeration										*/
	ui8		reserved1 [10];
	...
	ui16	generalFlags;							/*!<  See @ref AutoPID2_GeneralFlag_t enumeration									*/
	ui8		startupCfg;								/*!<  See @ref AutoPID2_StartupCfg enumeration										*/
	ui8		reserved3 [22];
	...
	/**	@cond
	 */
	extern const ParameterReferenceInfo_t autoPID2_ReferenceInfoArray [];
...
typedef struct __PACKED__
{
	...
	/**	@cond
	 */
	extern const ParameterReferenceInfo_t autoPID_StateReferenceInfoArray [];
...
typedef struct
{
	...
	/**	@cond
	 */
	extern const ParameterReferenceInfo_t scriptDebugInfoReferenceInfoArray [];
...
typedef struct __PACKED__
{
	...
	/**	@cond
	 */
	extern const ParameterReferenceInfo_t stateVarsReferenceInfoArray [];
 ...
 *			RX 4 bytes
 *
 *	@ref	SBGC32_ParseEventCmd function
 */
typedef struct __PACKED__
{
...
typedef struct __PACKED__
{
	...
	ui16	notesFreqHz [MAX_NOTES_QUANTITY];		/*!<  Units: Hz																		*/

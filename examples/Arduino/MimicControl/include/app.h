 ...
 *
 *	# Demo: gimbal will repeat motion of the remote controller build of
 *	  2 potentiometers and 2 push-buttons:
 ...
 *		## Acceleration limit is set to a value that gimbal
 *		   can process without loosing sync in motors
 *	____________________________________________________________________
 */

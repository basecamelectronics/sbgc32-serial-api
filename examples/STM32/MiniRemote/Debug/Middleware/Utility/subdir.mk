...
Middleware/Utility/%.o Middleware/Utility/%.su Middleware/Utility/%.cyclo: ../Middleware/Utility/%.cpp Middleware/Utility/subdir.mk
...
Middleware/Utility/%.o Middleware/Utility/%.su Middleware/Utility/%.cyclo: ../Middleware/Utility/%.c Middleware/Utility/subdir.mk
...
clean-Middleware-2f-Utility:
	-$(RM) ./Middleware/Utility/Utils.cyclo ./Middleware/Utility/Utils.d ./Middleware/Utility/Utils.o ./Middleware/Utility/Utils.su ./Middleware/Utility/colors.cyclo ./Middleware/Utility/colors.d ./Middleware/Utility/colors.o ./Middleware/Utility/colors.su ./Middleware/Utility/gwinImgW.cyclo ./Middleware/Utility/gwinImgW.d ./Middleware/Utility/gwinImgW.o ./Middleware/Utility/gwinImgW.su ./Middleware/Utility/gwinMenuPref.cyclo ./Middleware/Utility/gwinMenuPref.d ./Middleware/Utility/gwinMenuPref.o ./Middleware/Utility/gwinMenuPref.su ./Middleware/Utility/printf.cyclo ./Middleware/Utility/printf.d ./Middleware/Utility/printf.o ./Middleware/Utility/printf.su ./Middleware/Utility/ugfxHelper.cyclo ./Middleware/Utility/ugfxHelper.d ./Middleware/Utility/ugfxHelper.o ./Middleware/Utility/ugfxHelper.su

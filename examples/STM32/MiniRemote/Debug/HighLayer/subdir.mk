...
HighLayer/%.o HighLayer/%.su HighLayer/%.cyclo: ../HighLayer/%.cpp HighLayer/subdir.mk
...
clean: clean-HighLayer

clean-HighLayer:
	-$(RM) ./HighLayer/main.cyclo ./HighLayer/main.d ./HighLayer/main.o ./HighLayer/main.su

.PHONY: clean-HighLayer

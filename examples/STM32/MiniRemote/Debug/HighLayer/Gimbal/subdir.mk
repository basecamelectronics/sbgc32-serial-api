...
CPP_SRCS += \
../HighLayer/Gimbal/gimbal.cpp 

OBJS += \
./HighLayer/Gimbal/gimbal.o 

CPP_DEPS += \
./HighLayer/Gimbal/gimbal.d 


# Each subdirectory must supply rules for building sources it contributes
HighLayer/Gimbal/%.o HighLayer/Gimbal/%.su HighLayer/Gimbal/%.cyclo: ../HighLayer/Gimbal/%.cpp HighLayer/Gimbal/subdir.mk
...
clean: clean-HighLayer-2f-Gimbal

clean-HighLayer-2f-Gimbal:
	-$(RM) ./HighLayer/Gimbal/gimbal.cyclo ./HighLayer/Gimbal/gimbal.d ./HighLayer/Gimbal/gimbal.o ./HighLayer/Gimbal/gimbal.su

.PHONY: clean-HighLayer-2f-Gimbal

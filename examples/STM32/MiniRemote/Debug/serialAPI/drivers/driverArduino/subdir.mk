...
CPP_SRCS += \
D:/basecam/SBGC32_Library/sbgc32-serial-api/serialAPI/drivers/driverArduino/driverArduino.cpp 

OBJS += \
./serialAPI/drivers/driverArduino/driverArduino.o 

CPP_DEPS += \
./serialAPI/drivers/driverArduino/driverArduino.d 


# Each subdirectory must supply rules for building sources it contributes
serialAPI/drivers/driverArduino/driverArduino.o: D:/basecam/SBGC32_Library/sbgc32-serial-api/serialAPI/drivers/driverArduino/driverArduino.cpp serialAPI/drivers/driverArduino/subdir.mk
...
clean: clean-serialAPI-2f-drivers-2f-driverArduino

clean-serialAPI-2f-drivers-2f-driverArduino:
	-$(RM) ./serialAPI/drivers/driverArduino/driverArduino.cyclo ./serialAPI/drivers/driverArduino/driverArduino.d ./serialAPI/drivers/driverArduino/driverArduino.o ./serialAPI/drivers/driverArduino/driverArduino.su

.PHONY: clean-serialAPI-2f-drivers-2f-driverArduino

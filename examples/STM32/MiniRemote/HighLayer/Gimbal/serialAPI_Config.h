...
#ifndef		_SERIAL_API_CONFIG_TEMPLATE_H_
#define		_SERIAL_API_CONFIG_TEMPLATE_H_
...
#define		SBGC_CALIB_MODULE		SET_ON			/*!<  Allow work with calibration functions											*/
...
#define		SBGC_PROFILES_MODULE	SET_ON			/*!<  Allow profile configurations													*/
...
#define		SBGC_REF_INFO			SET_ON			/*!<  Debug mode flag for getting access to auxiliary info about system parameters	*/
#define		SBGC_ADJ_VARS_REF_INFO	SET_ON			/*!<  Debug mode flag for getting access to auxiliary adjustable variable info		*/
#define		SBGC_ADJ_VARS_NAMES		SET_OFF			/*!<  Add names to adjustable variable definition									*/
#define		SBGC_ADJ_VARS_ADD_FLAG	SET_ON			/*!<  Extend adjustable variables structure by user-defined variables				*/
...
#define		UNEXP_CMD_BUFFER		SET_ON			/*!<  Disable or enable command buffering											*/
	#define	UNEXP_CMD_BUFFER_SIZE	10				/*!<  8 Min --> 16 Max. Buffer size for received unexpected serial commands.
														  Various powers of 2															*/
...
#define		SBGC_STARTUP_DELAY		500				/*!<  Units: milliseconds. System startup delay parameter							*/
	 ...
	 *
	 *	@ref	See AdjVarGeneral_t structure
	 */
	typedef struct
	{
...
#define		SBGC_USE_STM32_DRIVER	SET_ON			/*!<  Using a STM32 controller as a master device									*/
	...
	#define	DEBUG_SERIAL_SPEED		115200			/*!<  Debug UART serial speed														*/
	/**	@}
	 */
	 ...
	 */
	#define	DRV_USE_FREERTOS		SET_ON			/*!<  UART driver required FreeRTOS support											*/

	#define	DRV_USE_CUBEMX			SET_OFF			/*!<  If set off: whole SBGC32 driver configured manually
	...
	#define	DRV_HAL_NVIC_UART		SET_OFF			/*!<  UART driver works with NVIC through HAL										*/
	#define	DRV_HAL_DMA_UART		SET_ON			/*!<  UART driver works with DMA through HAL										*/
	...
	#define	DRV_USE_UART_DEBUG		SET_OFF			/*!<  UART debug flag																*/

	#define	DRV_TX_BUFFER_SIZE		3				/*!<  Various powers of 2, starting from 8 (256). 1 Min --> 7 Max					*/
	#define	DRV_RX_BUFFER_SIZE		3				/*!<  Various powers of 2, starting from 8 (256). 1 Min --> 7 Max					*/

...
#define		PROFILE_BUTTON_MARGINS	5
#define		PROFILE_BUTTONS_WIDTH	26
#define		PROFILE_BUTTONS_HEIGHT	20
#define		PROFILE_BUTTONS_Y_COORD	((DISPLAY_HEIGHT / 2) - (PROFILE_BUTTON_MARGINS * 2))

#define		PROFILE_BUTTON_X_STEP	(PROFILE_BUTTON_MARGINS + PROFILE_BUTTONS_WIDTH)

#define		SELECT_PROFILE_ARROW_X_COORD	(PROFILE_BUTTON_MARGINS + (PROFILE_BUTTONS_WIDTH / 2) - (SELECT_ARROW_SIZE / 2))

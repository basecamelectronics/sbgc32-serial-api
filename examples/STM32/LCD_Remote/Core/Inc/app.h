 ...
 */
/*  - - - - - User Defined Parameters - - - - - - */
/* BLUETOOTH_HC05. Be sure to use HC-05 module with KEY pin. This pin should be pulled to 3.3V
 * If you are using bluetooth module, set the SBGC_RX_WAITING to at least 500
 */

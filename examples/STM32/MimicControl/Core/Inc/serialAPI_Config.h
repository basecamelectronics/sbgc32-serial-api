...
#define		SBGC_REALTIME_MODULE	sbgcOFF			/*!<  Realtime data processing. See @ref Realtime module							*/
...
#define		SBGC_NEED_DEBUG			sbgcOFF			/*!<  The system will print debug messages using callback function in driver		*/
#if (SBGC_NEED_DEBUG)
	#define	SBGC_LOG_COMMAND_TIME	sbgcOFF			/*!<  Add serial command completion time to log										*/
	#define	SBGC_LOG_COMMAND_NUMBER	sbgcOFF			/*!<  Add serial command number to log												*/
	#define	SBGC_LOG_COMMAND_DIR	sbgcOFF			/*!<  Add serial command type (Tx/Rx) to log										*/
	#define	SBGC_LOG_COMMAND_NAME	sbgcOFF			/*!<  Add serial command name to log												*/
	#define	SBGC_LOG_COMMAND_ID		sbgcOFF			/*!<  Add serial command ID to log													*/
	#define	SBGC_LOG_COMMAND_STATUS	sbgcOFF			/*!<  Add serial command status to log												*/
...
#define		SBGC_USE_STM32_DRIVER	sbgcON			/*!<  Using an STM32 controller as a master device									*/
	...
	#define	SBGC_SERIAL_SPEED		115200			/*!<  SBGCs UART serial speed														*/
		...
		#define	SBGC_DRV_HAL_TIMER	sbgcON			/*!<  Timer driver works with NVIC through HAL										*/
	...
	#define	SBGC_DRV_HAL_NVIC_UART	sbgcON			/*!<  UART driver works with NVIC through HAL										*/
	...
	#define	SBGC_DRV_CONFIGURED		sbgcON			/*!<  Enable if the UART and timer have already been initialized via CubeMX or by
